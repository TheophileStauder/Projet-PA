...
void jouer(){
    ...
    int continuer = 1;
    char** map = lire_fichier("assets/monde/monde1", &continuer) ;
    int nbLife = 800;
    tank_t tank2 ;
    tank2 = cons() ;
    ...
    musique = Mix_LoadMUS("assets/music/musique.mp3"); //Chargement de la musique
    ...
    Mix_Chunk *son2 ;
    son = Mix_LoadWAV("assets/music/son.wav"); //Charger un wav dans un pointeur
    son2 = Mix_LoadWAV("assets/music/Ta Da-SoundBible.com-1884170640.wav") ;
    ...
    terre = SDL_LoadBMP("assets/texture/terreBon.bmp") ;
    mur = SDL_LoadBMP("assets/texture/murBon.bmp") ;
    initialise_Pos_Tank = SDL_LoadBMP("assets/texture/tank_bas.bmp") ;
    tank_haut = SDL_LoadBMP("assets/texture/tank_haut.bmp") ;
    tank_bas = SDL_LoadBMP("assets/texture/tank_bas.bmp") ;
    tank_droite = SDL_LoadBMP("assets/texture/tank_droite.bmp") ;
    tank_gauche = SDL_LoadBMP("assets/texture/tank_gauche.bmp") ;
    tour = SDL_LoadBMP("assets/texture/tourelle.bmp") ;
    bullet = SDL_LoadBMP("assets/texture/bullet.bmp");
    flag = SDL_LoadBMP("assets/texture/flag.bmp");
    explosion = SDL_LoadBMP("assets/texture/explosion.bmp");
    life = SDL_LoadBMP("assets/texture/life.bmp");
    mur_bleu = SDL_LoadBMP("assets/texture/mur_bleu.bmp");
    terre_bleue = SDL_LoadBMP("assets/texture/terre_bleue.bmp");
    mur_sapin = SDL_LoadBMP("assets/texture/mur_sapin.bmp");
    terre_blanche = SDL_LoadBMP("assets/texture/terre_blanche.bmp");
    terre_grise = SDL_LoadBMP("assets/texture/gris.bmp") ;
    mur_noir = SDL_LoadBMP("assets/texture/mur_noir.bmp");
    win = SDL_LoadBMP("assets/texture/you_win.bmp");
    ...
    while(continuer){
        ...
        if(get_level(tank2)==NB_FLAG){
            update_monde(tank2);
            if(tank2->monde == 2){map = lire_fichier("assets/monde/monde2", &continuer);}
            if(tank2->monde == 3){map = lire_fichier("assets/monde/monde3", &continuer);}
            if(tank2->monde == 4){map = lire_fichier("assets/monde/monde4", &continuer);}
